      ...
      <div className='flex gap-[32px] flex-wrap lg:flex-nowrap'>
        ...
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col justify-center items-center lg:items-start gap-4 h-full'>
            ...
            <h1 className='text-4xl sm:text-5xl font-bold text-center lg:text-left'>Muhammad Abdullah</h1>
            ...
            <div className='flex gap-4'>
              <Link href="#contact" className='px-6 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 transition focus:outline-none'>Contact Me</Link>
              <Link href="#projects" className='px-6 py-3 border border-blue-600 text-blue-600 rounded hover:bg-blue-100 transition focus:outline-none'>View Projects</Link>
            </div>
          </div>
        </div>
